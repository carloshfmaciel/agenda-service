package br.com.app.domain.agenda.controller.operations.create;
...
public interface AgendaCreateControllerSwagger {
	
	@Operation(summary = "Create agenda", description = "REST Endpoint that creates a new agenda")
