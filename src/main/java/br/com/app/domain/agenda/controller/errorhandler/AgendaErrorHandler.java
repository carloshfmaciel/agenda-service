package br.com.app.domain.agenda.controller.errorhandler;
...
@RestControllerAdvice("br.com.app.domain.agenda.controller.operations")
@FieldDefaults(level = AccessLevel.PRIVATE)
@AllArgsConstructor(onConstructor_ = @Autowired)
@Slf4j
public class AgendaErrorHandler {

	@ExceptionHandler(value = { AgendaNotFoundException.class })
